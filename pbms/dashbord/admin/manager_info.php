...
if ($_SESSION["loggedin"] !== true) {
    ...
    $sql = "SELECT * FROM `manager` WHERE `id` = '$m_id'";
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-1">Manager Id:<?php echo $id; ?></p>
                        <p class="text-muted mb-4">Under Admin Id:<?php echo $_SESSION['id']; ?></p>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0">Total tranaction time</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">300 times</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0">Total tranaction Amount</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">300000 tk</p>
                            </div>
                        </div>
                    </div>
                </div>
