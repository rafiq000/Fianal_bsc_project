                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <td>" . $row["reg_time"] . "</td>
                                        <td><a class='btn btn-primary' href='customer_info.php?id=" . $row["goods_id"] . "' role='button'>update</a><a class='btn btn-danger' href='customer_info.php?id=" . $row["goods_id"] . "' role='button'>delete</a></td>
                                        </tr>";
                                    }
                                    ?>
                                </tbody>
