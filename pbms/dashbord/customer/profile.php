...
if ($_SESSION["loggedin"] !== true) {
    ...
    $sql = "SELECT * FROM `customer` WHERE `user_name` = '$se_username'";
    ...
    $_SESSION["manager_id"] = $manager_id = $result["manager_id"];
    // } else {
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-1">Under (Manager) : fahad</p>
                        <p class="text-muted mb-4"></p>
                        <div class="d-flex justify-content-center mb-2">
                            <!-- <button type="button" class="btn btn-primary">Follow</button> -->
                            <button type="button" class="btn btn-outline-primary ms-1">Change Passwoard</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">12 times <span><button type="submit" class="btn btn-outline-primary ms-1">Generete Statement</button></span></p>
                            </div>
                        </div>
                    </div>
                </div>
