        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="manager.php" class="nav_link <?php if ($pg == 'manager') { ?>active<?php } ?>">
                        <i class='bx bx-folder nav_icon' data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true" title=" <b>Manager</b>"></i> <span class="nav_name">Manager</span>
                    </a>
                    ...
                    <a href="paid.php" class="nav_link <?php if ($pg == 'paid') { ?>active<?php } ?>">
                        <i class='bx bx-message-square-detail nav_icon' data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true" title=" <b>Buy</b>"></i> <span class="nav_name">Buy</span>
                    </a>
                    <a href="sell.php" class="nav_link <?php if ($pg == 'sell') { ?>active<?php } ?>">
                        <i class='bx bx-message-square-detail nav_icon' data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true" title=" <b>Sell</b>"></i> <span class="nav_name">Sell</span>
                    </a>
                </div>
            </div>
