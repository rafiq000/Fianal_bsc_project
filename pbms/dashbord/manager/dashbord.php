        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Current Profit: 20000 tk</p>
                </div>
            </div>
        </div>
        <br>
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Total Transaction: 100000 tk</p>
                    <p class="card-text">Total Paid Amount: 400000 tk</p>
                    <p class="card-text">Total Take Amount: 600000 tk</p>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Total Transaction times: 30 times</p>
                    <p class="card-text">Total Paid times: 28 times</p>
                    <p class="card-text">Total Take times: 2 times</p>
                </div>
            </div>
        </div>
