...
if ($_SESSION["loggedin"] !== true) {
    ...
    $sql = "SELECT * FROM `customer` WHERE `id` = '$m_id'";
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <!-- <p class="text-muted mb-4">Under Admin Id:<?php //echo $_SESSION['id']; 
                                                                        ?></p> -->
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <p class="text-muted mb-0"> 20 times <span><button type="submit" class="btn btn-primary">Generete Statement</button></span></p>
                            </div>
                        </div>
                    </div>
                </div>
