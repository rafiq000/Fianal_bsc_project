...
if ($_SESSION["loggedin"] !== true) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO `paid`(`customer_id`, `manager_id`, `amount`) VALUES ('$customer_id','$id','$goods_amount')";
...
<div class=" container">
    <section>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class=" text-center">Pay Money To The Customer</h3>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Customer Id</label>
                            <input type="text" class="form-control" name="customer_id" value="<?php if (isset($cust_id)) {
                                                                                                    echo $cust_id;
                                                                                                }; ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary col-3" name="submit">Pay</button>
                        <span><?php
