...
if ($_SESSION["loggedin"] !== true) {
    ...
    $sql = "SELECT * FROM `admin` WHERE `user_name` = '$se_username'";
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-1">Adminstrator</p>
                        <p class="text-muted mb-4">Some shop Name</p>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0"><?php  ?>rafic@admin.com</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
